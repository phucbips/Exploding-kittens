...
// SECURITY: Helper to generate secure random integers, mitigating predictable Math.random() usage
...
// SECURITY: Helper to generate secure UUIDs
const getSecureId = () => {
...
export const initializeGame = (playerNames) => {
  ...
  const players = playerNames.map((name, index) => ({
    id: `player_${index}_${getSecureId()}`,
    name,
    hand: [],
    isAlive: true,
