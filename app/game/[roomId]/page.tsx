  ...
  const handleDrawCard = async () => {
    ...
    if (card.type === 'EXPLODE') {
        ...
        if (defuseIndex !== -1) {
            ...
            // Re-insert Explode
            const secureRandomFloat = globalThis.crypto.getRandomValues(new Uint32Array(1))[0] / (0xFFFFFFFF + 1);
            const insertIndex = Math.floor(secureRandomFloat * (newDeck.length + 1));
